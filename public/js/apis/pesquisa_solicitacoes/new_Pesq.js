...
$("#buscar").on("click", function(e)
{
    ...
    let number_ficha     = document.getElementById("validationCustom01").value;
    let data_pesquisa    = formatData($("input[name='data_pesq']").val());
    let motorista_N   = document.getElementById("motorist_qual").value

    if(number_ficha == "" && data_pesquisa == "" && motorista_N == "")
    {
        msgError()
    }else
    {
...
// let dataSolicitacao = $("#data_soli").val();
...
function tableS()
{
number_ficha = document.getElementById("validationCustom01").value;
data_pesquisa    = formatData($("input[name='data_pesq']").val());
motorista_N   = document.getElementById("motorist_qual").value
        $.ajax({
            method: "GET",

            url:  url_p+"api/get_solicitations_filter",
            data: {
            ...
            success: function(e)
            {
              ...
              data.forEach(function(item)
              {
                ...
                {
                  $('#corpo_lista').append(makeTable(dados));
                })
                 })
              }
            }
...
{
    let dataSolicitacao = data.data_solicitacao.replaceAll("-", "/");
    let table =``
    table += `<tr>
    <th class="text-center align-middle" scope='row'>${data.numero_ficha}</th>
    <th class="text-center align-middle">${dataSolicitacao}</th>
    ${changeStatus(data.retorno, data.cancelamento, data.ida)}
    <th class='d-flex justify-content-center'>
        <button value='${data.id_solicitacao}' onclick='editSolicitation(${data.id_solicitacao});' type='button' class='btn btn-sm btn-secondary mr-1 myBtnE' id='myBtn2'><i class='fa fa-edit'></i> Editar</button>
        <button value='${data.id_solicitacao}' onclick='visualizeSolicitation(${data.id_solicitacao})' type='button' class='btn btn-sm btn-secondary ml-1' id='myBtn'><i class='fa fa-eye'></i> Visualizar</button>
    </th>
   </tr>`;
    return table
}

function atribuirVisualizarDestinos(destinos)
{
    console.log("AQ")
...
function atribuirEditarDestinos(destinos)
{
      ...
      data: data_pesquisa
        ...
        success: function(e)
        {
          ...
          var incor = $('#incor_checkbox').length;
            ...
            atribuirEditarDestinos(v.destino.split(";"));
...
function visualizeSolicitation(id)
{
  data_pesquisa = formatData($("input[name='data_pesq']").val());
    ...
    data: {
      data: data_pesquisa
        ...
        success: function(e)
        {
            ...
            {
                v = value
                $("#myModal5").append(makeVisualize(v))
                atribuirVisualizarDestinos(v.destino.split(";"));
            })
...
function makeContentEdit(data)
{
    ...
    if(data.n_ramalN != 0){
      ...
      RamalF = data.n_ramalN;

    }else{

      RamalF = data.sol_ramal;
    ...
    <div class="custom-control custom-checkbox col-md-1 ml-4 mb-3 box-box1">
        ...
        <div class="form-row">
          ...
          <div class="col-md-2">
            ...
            <input value="${data.hora_solicitacao}" name="hora_sol" type="text" class="form-control form-control-sm" id="hora_soli" required maxlength="10">
            <div class="invalid-feedback">
              Please provide a valid city.
            </div>
          </div>
        ...
        <div class="col">
          ...
          <input id="ramal_sol" value="${RamalF}" name="ramal_sol" type="text" class="form-control form-control-sm" disabled>
        </div>
        </div>
...
function makeVisualize(data)
{
  ...
  <div class="col-md-7  mb-2">
    ...
    <div class="form-row">
      <div class="col-md-3">
        <label for="validationCustom03" style ="margin:10px 10px 0px 0px">Data</label>
        <input value="${trocaBarra(data.data_solicitacao)}" type="text" class="form-control form-control-sm" id="validationCustom03" required readonly>
        <div class="invalid-feedback">
          Please provide a valid city.
        </div>
      </div>
      <div class="col-md-2">
        ...
        <input value="${data.hora_solicitacao}" name ="hora_sol" type="text" class="form-control form-control-sm" id="validationCustom03" required readonly>
        <div class="invalid-feedback">
          Please provide a valid city.
        </div>
      </div>
  ...
  <div class="col">
    <label for="validationCustom05" style ="margin:10px 10px 0px 0px">Ramal</label>
    <input disabled readonly id="ramal_sol" value="${RamalF}" name="ramal_sol" type="text" class="form-control form-control-sm" id="ramal_sol" required>
  </div>
    </div>
    <div class="form-row">
        <div class="col-md-2">
    ...
    <div class="form-row">
        ...
        <div class="col-md-7 visuaFormDest">
            <label for="visdestino" style ="margin:10px 10px 0px 0px">Destino</label>
            <input type="text" class="form-control form-control-sm" id="visdestino" readonly>
        </div>
        <div class="col-md-6 visuaFormDest">
            <label for="visdestino2" style ="margin:10px 10px 0px 0px">Destino2</label>
            <input type="text" class="form-control form-control-sm" id="visdestino2" readonly>
        </div>
        <div class="col-md-6 visuaFormDest">
            <label for="visdestino3" style ="margin:10px 10px 0px 0px">Destino3</label>
            <input type="text" class="form-control form-control-sm" id="visdestino3" readonly>
        </div>
        <div class="col-md-6 visuaFormDest">
            <label for="visdestino4" style ="margin:10px 10px 0px 0px">Destino4</label>
            <input type="text" class="form-control form-control-sm" id="visdestino4" readonly>
        </div>
        <div class="col-md-6 visuaFormDest">
            <label for="visdestino5" style ="margin:10px 10px 0px 0px">Destino5</label>
            <input type="text" class="form-control form-control-sm" id="visdestino5" readonly>
        </div>
      ...
      <div class="form-row d-flex justify-content-between">
            <div class="col-md-2 mb-3">
              ...
              <div class="col-md-3 mb-3">
                  ...
                  <input type="text" class="form-control form-control-sm" id="validationCustom03" required value="${data.ch_horario}" disabled>
                  <div class="invalid-feedback ">
                      Please provide a valid city.
                  </div>
                </div>
